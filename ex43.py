...
class Death(Scene):
    ...
    quips = [
        ...
        "I have a goldfish that's better at this.",
        "I have come to the conclusion that you've been dropped on the head.",
        "Suck less, peasant!"
    ]
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot":
            ...
            print "Lbhe zbgurge vf fb sng, jura jur fvgf nebhaq gur ubhfr, fur fvgf"
            print "nehbaq gur ubhfr."
